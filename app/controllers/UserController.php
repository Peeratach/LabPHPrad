...
class UserController extends BaseController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		$this->view->page_title ="User";
		$this->view->render('user/list.php' , $data ,'main_layout.php');
	}
	/**
     * Load csv|json data
     * @return data
	...
	function import_data(){
		...
		$list_page = (!empty($_POST['redirect']) ? $_POST['redirect'] : 'user/list');
	...
	function view( $rec_id = null , $value = null){
		...
		if(!empty($record)){
			...
			$this->view->render('user/view.php' , $record ,'main_layout.php');
		}
		else{
			$page_error = null;
			if($db->getLastError()){
	...
	function add(){
		...
		$this->view->page_title ="Add New User";
		$this->view->render('user/add.php' ,null,'main_layout.php');
	}
	/**
     * Edit Record Action 
	...
	function edit($rec_id = null){
		...
		if(!empty($data)){
			$this->view->render('user/edit.php' , $data, 'main_layout.php');
		}
		else{
			if($db->getLastError()){
