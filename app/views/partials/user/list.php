                        ...
                        <div class="">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    if(!empty($field_name)){
                                    ?>
                                    <li class="breadcrumb-item"><a class="text-capitalize" href="<?php print_link('user') ?>"><?php echo $field_name ?></a></li>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td><a href="<?php print_link("user/view/$data[id]") ?>"><?php echo $data['id']; ?></a></td>
                                                    ...
                                                    <td>
                                                        <a  data-source='<?php echo json_encode_quote(Menu :: $name); ?>' 
                                                            ...
                                                            data-url="<?php print_link("user/editfield/$data[id]"); ?>" 
                                                            data-name="name" 
                                                    ...
                                                    <td>
                                                        <a  data-source='<?php echo json_encode_quote(Menu :: $name); ?>' 
                                                            data-value="<?php echo $data['password']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("user/editfield/$data[id]"); ?>" 
                                                            data-name="password" 
                                                    ...
                                                    <th class="td-btn">
                                                        ...
                                                        <a class="btn btn-sm btn-success has-tooltip" title="View Record" href="<?php print_link('user/view/'.$data['id']); ?>">
                                                            <i class="fa fa-eye"></i> 
                                                        </a>
                                                        
                                                        
                                                        <a class="btn btn-sm btn-info has-tooltip" title="Edit This Record" href="<?php print_link('user/edit/'.$data['id']); ?>">
                                                            <i class="fa fa-edit"></i> 
                                                        </a>
                                                        
                                                        
                                                        <a class="btn btn-sm btn-danger recordDeletePromptAction has-tooltip" title="Delete this record" href="<?php print_link("user/delete/$data[id]/?csrf_token=$csrf_token"); ?>" >
                                    ...
                                    <div class="">
                                        <div class="row">   
                                            <div class="col-sm-4">  
                                                ...
                                                <button data-prompt-msg="Are you sure you want to delete these records" data-url="<?php print_link("user/delete/{sel_ids}/?csrf_token=$csrf_token"); ?>" class="btn btn-sm btn-danger btn-delete-selected d-none">
